...
- **DuckDB string concatenation**: DuckDB uses `||`, not `+`. SQLAlchemy's PostgreSQL dialect generates `+` for string concat. Use `literal_column("(... || ...)")` to write raw SQL.
